...
//     <div className="absolute inset-0 z-10 flex items-center justify-center w-full h-full bg-gray-800 bg-opacity-50">
//       <div className="relative flex h-[220px] w-[350px] flex-col justify-between rounded-3xl bg-white px-5 py-6">
//         <div>
//           <p className="text-gray-800 tp-title1-semibold">{title}</p>
//           {description && (
